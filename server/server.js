...
const db = new sqlite3.Database('world_sql_content_683f6ecb4976bed01885c945993321d8.sqlite3', (err) => {
  if (err) {
...
app.get('/get-data', (req, res) => {
  db.all('SELECT json FROM DestinyVendorDefinition WHERE id = -2139803745;', (err, rows) => {
    if (err) {
      console.error(err.message);
