...
const Footer =() => {
    return(
            ...
            <div className="col-md-4 d-flex align-items-center">
                <Link className="mb-1 me-2 mb-md-0 text-body-secondary text-decoration-none lh-1 text-light" to="/">
                    <FontAwesomeIcon className = "text-light px-2" icon={faMoon} size="xl" />
                </Link>
                <span className="mb-1 mb-md-0 text-body-secondary"><Link className="text-decoration-none link-light" to="/">© 2023 Guardians Central, Inc</Link></span>
            </div>
